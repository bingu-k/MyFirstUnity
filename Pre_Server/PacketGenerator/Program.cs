...
namespace PacketGenerator
{
    class Program
    {
        ...
        public static void ParsePacket(XmlReader r)
        {
            ...
            {
                Console.WriteLine("Invailed packet node");
                return;
            }
            ...
            if (packetName.StartsWith("S_") || packetName.StartsWith("s_"))
                clientRegister += string.Format(PacketFormat.manangerRegisterFormat, packetName) + Environment.NewLine;
            else
                serverRegister += string.Format(PacketFormat.manangerRegisterFormat, packetName) + Environment.NewLine;
        }
        ...
        public static Tuple<string, string, string> ParseMembers(XmlReader r)
        {
            ...
            string memberCode = "", readCode = "", writeCode = "";
